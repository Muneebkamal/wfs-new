            ...
            <div class="card-body">
                <div class="row align-items-center mb-3">
                    <div class="col-md-12 text-end">
                        <a class="btn btn-sm btn-secondary" href="#">Cancelled Orders</a>
                        <a class="btn btn-sm btn-secondary" href="#">Monthly Report by SKU</a>
                ...
                <form>
                    <div class="row align-items-end">
                        <div class="col-md-2">
                            ...
                            <input type="text" name="order_id" class="form-control form-control-sm" placeholder="Enter Customer Order ID" value="">
                        </div>
                        <div class="col-md-2">
                            <label>SKU</label>
                            <input type="text" name="sku" class="form-control form-control-sm" placeholder="Enter SKU" value="">
                        </div>
                        <div class="col-md-2"> 
                            <label>Status</label>
