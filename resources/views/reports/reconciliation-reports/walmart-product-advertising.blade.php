...
@section('title', 'Walmart Product Advertising')

@section('content')
<div class="">
    <h5 class="m-0">Walmart Product Advertising</h5>
</div>
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-12 table-responsive mt-3">
                <table id="walmart_product_advertising" class="table table-striped">
                    <thead>
                        <th>#</th>
...
@section('scripts')
<script>
    $('#walmart_product_advertising').dataTable();
</script>
@endsection