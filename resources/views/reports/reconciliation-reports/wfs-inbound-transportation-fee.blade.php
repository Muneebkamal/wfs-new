...
@section('title', 'WFS Inbound Transportation Fee')

@section('content')
<div class="">
    <h5 class="m-0">WFS Inbound Transportation Fee</h5>
</div>
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-12 table-responsive mt-3">
                <table id="wfs_inbound_transportation_fee" class="table table-striped">
                    <thead>
                        <th>#</th>
...
@section('scripts')
<script>
    $('#wfs_inbound_transportation_fee').dataTable();
</script>
@endsection