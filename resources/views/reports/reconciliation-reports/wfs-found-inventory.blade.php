...
@section('title', 'WFS Found Inventory')

@section('content')
<div class="">
    <h5 class="m-0">WFS Found Inventory</h5>
</div>
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-12 table-responsive mt-3">
                <table id="wfs_found_inventory" class="table table-striped">
                    <thead>
                        <th>#</th>
