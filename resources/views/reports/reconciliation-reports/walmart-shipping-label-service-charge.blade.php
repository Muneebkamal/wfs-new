...
@section('title', 'WFS Storage Fee')

@section('content')
<div class="">
    <h5 class="m-0">Walmart Shipping Label Service Charge</h5>
</div>
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-12 table-responsive mt-3">
                <table id="walmart_shipping_label_service_charge" class="table table-striped">
                    <thead>
                        <th>#</th>
...
@section('scripts')
<script>
    $('#walmart_shipping_label_service_charge').dataTable();
</script>
@endsection