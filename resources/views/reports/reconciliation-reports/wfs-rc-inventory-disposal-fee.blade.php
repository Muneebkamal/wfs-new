...
@section('title', 'WFS RC Inventory Disposal Fee')

@section('content')
<div class="">
    <h5 class="m-0">WFS RC Inventory Disposal Fee</h5>
</div>
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-12 table-responsive mt-3">
                <table id="wfs_disposal_fee" class="table table-striped">
                    <thead>
                        <th>#</th>
